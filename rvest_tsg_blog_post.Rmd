...
Scrape the website of one of my favorite football clubs to get an overview
...
We want to extract the content of every article. Therefore
...
targets pipeline (have a look at '_targets.R'), that the function is executed
exactly once per article. This means future runs of the pipeline will detect
if a article is already scraped and only scrape newly added articles, making
